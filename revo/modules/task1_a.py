...
def task1_a(start_year: int, start_quarter: int, end_year: int, end_quarter: int, pvalue: float = 0.05):
    # Import cleaned data
    ...
    for financial_col in Y_cols:
        ...
        if p_values.mean() <= 0.05:
            ...
            plot_lin_reg_scatter(df, financial_col, coefficients.mean(), p_values.mean(), "2_task1_a")
